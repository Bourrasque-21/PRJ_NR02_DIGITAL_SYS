...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {mode_sw[1]}]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {mode_sw[2]}]
set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports {mode_sw[3]}]
...
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports btn_8] 
